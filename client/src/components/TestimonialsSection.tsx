    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mt-16 animate-on-scroll opacity-0">
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4 bg-white/80 backdrop-blur-sm p-4 sm:px-8 sm:py-4 rounded-2xl sm:rounded-full shadow-xl border border-white/50 max-w-2xl mx-auto">
            <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-2">
              ...
              <div className="text-center sm:text-left">
                ...
                <p className="text-xs sm:text-sm text-gray-600">+100 avaliações 5 estrelas</p>
              </div>
            </div>
