  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        ...
        {/* Scroll Indicator */}
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 opacity-0 animate-bounce" style={{animation: 'fadeIn 1s 2s ease-out forwards, bounce 2s 2s infinite'}}>
