  ...
  const socialLinks = [
    {
      ...
      color: "text-clinic-red hover:text-red-600",
      label: "WhatsApp"
    },
    {
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-gray-600" data-testid="footer-contact-info">
              ...
              <div className="flex items-center space-x-3 group">
                <div className="bg-green-500/20 p-2 rounded-xl group-hover:bg-green-500/30 transition-colors duration-300">
              ...
              <div className="flex items-center space-x-3 group">
                <div className="bg-blue-500/20 p-2 rounded-xl group-hover:bg-blue-500/30 transition-colors duration-300">
