...
// Modern outline icons following brand design patterns
...
export const TrustIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg
    ...
    className={className}
  >
    <path d="M10 12H8c-1.1 0-2-.9-2-2V7c0-1.1.9-2 2-2h2" />
    <path d="M14 12h2c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2h-2" />
    <path d="M10 12v3c0 1.1.9 2 2 2s2-.9 2-2v-3" />
    <path d="M10 12h4" />
...
export const MedicalIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
